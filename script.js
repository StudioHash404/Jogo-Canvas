...
menu2_spr.src = "assets/menu.png";
let menu2Largura = 200;  // Largura
let menu2Altura = 200;   // Altura
let menu2X = 50;         // Posicao X
let menu2Y = 400;        // Posicao Y
//------------------------------
let nuvem_spr = new Image();
nuvem_spr.src = "assets/nuvem.png";
let nuvemLargura = 200;
let nuvemAltura = 200;
let nuvemX = 150;
let nuvemY = 70;
//------------------------------
let nuvem2_spr = new Image();
nuvem2_spr.src = "assets/nuvem.png";
let nuvem2Largura = 200;
let nuvem2Altura = 200;
let nuvem2X = 400;
let nuvem2Y = 70;
//------------------------------
let fogo_spr = new Image();
fogo_spr.src = "assets/fogo.png";
let fogoLargura = 200;
let fogoAltura = 200;
let fogoX = 530;
let fogoY = 400;
...
fogo2_spr.src = "assets/fogo.png";
let fogo2Largura = 200;
let fogo2Altura = 200;
let fogo2X = 50;
let fogo2Y = 400;
//------------------------------
...
//---------MENU-START----------------------------
 if (game.state === "start") {
     ...
     * https://www.programicio.com/web/javascript/canvas-api/criando-gradientes
     */
